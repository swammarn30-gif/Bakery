...
- The local preview’s password-auth endpoint was also checked during the Liquid Glass visual pass and returned HTTP 200. Production, rather than the local browser session, remains the authoritative sign-in verification environment.
